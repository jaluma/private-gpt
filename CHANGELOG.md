...
* **llm:** add progress bar when ollama is pulling models ([#2031](https://github.com/jaluma/private-gpt/issues/2031)) ([cf61bf7](https://github.com/jaluma/private-gpt/commit/cf61bf780f8d122e4057d002abf03563bb45614a))
...
* **ui:** Allows User to Set System Prompt via "Additional Options" in Chat Interface ([#1353](https://github.com/jaluma/private-gpt/issues/1353)) ([145f3ec](https://github.com/jaluma/private-gpt/commit/145f3ec9f41c4def5abf4065a06fb0786e2d992a))
...
* add built image from DockerHub ([#2042](https://github.com/jaluma/private-gpt/issues/2042)) ([f09f6dd](https://github.com/jaluma/private-gpt/commit/f09f6dd2553077d4566dbe6b48a450e05c2f049e))
* add numpy issue to troubleshooting ([#2048](https://github.com/jaluma/private-gpt/issues/2048)) ([4ca6d0c](https://github.com/jaluma/private-gpt/commit/4ca6d0cb556be7a598f7d3e3b00d2a29214ee1e8))
...
* Adding azopenai to model list ([#2035](https://github.com/jaluma/private-gpt/issues/2035)) ([1c665f7](https://github.com/jaluma/private-gpt/commit/1c665f7900658144f62814b51f6e3434a6d7377f))
...
* **deploy:** generate docker release when new version is released ([#2038](https://github.com/jaluma/private-gpt/issues/2038)) ([1d4c14d](https://github.com/jaluma/private-gpt/commit/1d4c14d7a3c383c874b323d934be01afbaca899e))
* **deploy:** improve Docker-Compose and quickstart on Docker ([#2037](https://github.com/jaluma/private-gpt/issues/2037)) ([dae0727](https://github.com/jaluma/private-gpt/commit/dae0727a1b4abd35d2b0851fe30e0a4ed67e0fbb))
...
* **docker:** docker broken copy ([#1419](https://github.com/jaluma/private-gpt/issues/1419)) ([059f358](https://github.com/jaluma/private-gpt/commit/059f35840adbc3fb93d847d6decf6da32d08670c))
...
* publish image name ([#2043](https://github.com/jaluma/private-gpt/issues/2043)) ([b1acf9d](https://github.com/jaluma/private-gpt/commit/b1acf9dc2cbca2047cd0087f13254ff5cda6e570))
...
* **ui:** gradio bug fixes ([#2021](https://github.com/jaluma/private-gpt/issues/2021)) ([d4375d0](https://github.com/jaluma/private-gpt/commit/d4375d078f18ba53562fd71651159f997fff865f))
...
* update matplotlib to 3.9.1-post1 to fix win install ([b16abbe](https://github.com/jaluma/private-gpt/commit/b16abbefe49527ac038d235659854b98345d5387))
